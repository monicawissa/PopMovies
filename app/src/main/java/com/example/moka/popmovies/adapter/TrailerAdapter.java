...
public class TrailerAdapter extends RecyclerView.Adapter<TrailerAdapter.MyViewHolder> {
    ...
    public TrailerAdapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.row_trailer, viewGroup, false);
    ...
    public void onBindViewHolder(final TrailerAdapter.MyViewHolder viewHolder, int i){
        ...
        String imageURL = "https://img.youtube.com/vi/"+trailerList.get(i).getKey()+"/0.jpg";
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View view){
            super(view);
            thumbnail = (ImageView) view.findViewById(R.id.trailer_img);
